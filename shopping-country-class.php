...
public function check_fun($value) {
...
$count=$count-1;
$a="";
foreach($explode as $b => $c){
/*echo $c;*/
/*echo "<br>";*/

if($b==0) {

$a.='{"optionValue":"'.$c.'", "optionDisplay": "'.$c.'"},' ;
}else if($b==$count) {
$a.='{"optionValue":"'.$c.'", "optionDisplay": "'.$c.'"}';
