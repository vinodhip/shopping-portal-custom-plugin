			...
			<div class="portal_container">
				...
				<?php $queried_category = get_queried_object(); ?>
					<div class="category_show_container">
						<h2 class="dynamic_heading" style="background:<?php echo get_option('hover_bg'); ?>;"><?php echo $queried_category->name; ?></h2>
						<!-- static -->
						...
						<?php 	$term_cat_id = $queried_category->term_id;
								...
								$args = array('post_type' => 'stores', 'posts_per_page' => -1 ,'meta_key' => 'sort_number', 'orderby' => 'meta_value', 'order' => 'ASC' ,'tax_query' => array( array( 'taxonomy' => $taxonomy_name, 'field' => 'term_id', 'terms' => $term_cat_id)));
