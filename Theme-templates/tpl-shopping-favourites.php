...
Template Name: Member-Shopping-Favourites-Template
			...
			<div class="portal_container">
				...
				<?php $queried_category = get_queried_object(); ?>
					<div class="category_show_container">
						<h2 class="dynamic_heading" style="background:<?php echo get_option('hover_bg'); ?>;">Favourites</h2>
						<!-- static -->
				...
				if(in_array($post->ID, $favourite_data)){
